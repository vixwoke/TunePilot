...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="pageTitlelbl" runat="server" Text="Edit Lesson" Font-Bold="true" Font-Size="XX-Large" Font-Names="Montserrat"></asp:Label>
    ...
    <asp:Label ID="lessonTitlelbl" runat="server" Text="Lesson Details" Font-Bold="true" Font-Size="Large" Font-Names="Montserrat"></asp:Label>
    ...
    <asp:Label ID="contentsTitlelbl" runat="server" Text="Lesson Contents" Font-Bold="true" Font-Size="Large" Font-Names="Montserrat"></asp:Label>
    ...
    <br />
    <asp:Label ID="quizTitlelbl" runat="server" Text="Quiz" Font-Bold="true" Font-Size="Large" Font-Names="Montserrat"></asp:Label>
    <br />
    <br />
    ...
    <br />
    <asp:Label ID="questionsTitlelbl" runat="server" Text="Questions" Font-Bold="true" Font-Size="Medium" Font-Names="Montserrat"></asp:Label>
    <br />
    <br />
    ...
    <asp:Panel ID="optionspnl" runat="server" Visible="false">
        <br />
        <asp:Label ID="optionsTitlelbl" runat="server" Text="Options" Font-Bold="true" Font-Size="Medium" Font-Names="Montserrat"></asp:Label>
        <br />
        <br />
