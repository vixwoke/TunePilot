    ...
    <div style="display: flex; gap: 20px;">
        ...
        <div style="flex: 2;">
            ...
            <asp:Panel ID="courseDetailpnl" runat="server" Visible="false">
                ...
                <br />
                <asp:Label ID="courseMessagelbl" runat="server" Visible="false" ForeColor="Red" Font-Names="Montserrat"></asp:Label>
                <br />
                ...
                <asp:Button ID="addLessonbtn" runat="server" Text="+ Add Lesson" OnClick="addLessonbtn_Click" />
                <asp:Button ID="addExambtn" runat="server" Text="+ Add Exam" OnClick="addExambtn_Click" />
