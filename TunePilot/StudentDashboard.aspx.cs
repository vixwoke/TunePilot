...
namespace TunePilot
{
    public partial class StudentDashboard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Session["instrument"] =
                    Convert.ToInt32(Request["__EVENTARGUMENT"]);
            }

            LoadDashboard();

            SetActiveIcon(
                Convert.ToInt32(Session["instrument"]));
        }
                ...
                new SqlConnection(connStr))
            {
                ...
                while (r.Read())
                {
                    ...
                    if (!guestLocked)
                    {
                        ...
                        btn.ID =
                            "Lesson_" +
                            r["lesson_id"].ToString();

                        btn.Text =
                            r["lesson_title"].ToString();
                    ...
                    string image =
                        "~/resources/studentDashboard/square.png";

                    if (status == "in progress")
                    {
                        image =
                            "~/resources/studentDashboard/square2.png";
                    }

                    if (status == "completed")
                    {
                        image =
                            "~/resources/studentDashboard/square1.png";
                    }
        ...
        void LoadQuizzes()
        {
                ...
                new SqlConnection(connStr))
            {
                ...
                while (r.Read())
                {
                    ...
                    {
                        image =
                            "~/resources/studentDashboard/square3.png";
                    }
     ...
     EventArgs e)
        ...
        void ApplyGuestRestrictions()
        {
            ...
            {
                LoginUnlock.Text =
                    "Login to unlock more lessons, quizzes and exams.";
            }
        }

        void SetActiveIcon(int id)
        {
            // Reset borders and images
