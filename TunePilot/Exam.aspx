<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Exam.aspx.cs" Inherits="TunePilot.Exam" MasterPageFile="~/navbar.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Exam - TunePilot</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="exam-page-wrapper">
        ...
        <div class="exam-header-card">
            ...
            <p class="exam-desc"><asp:Label ID="ExamDescription" runat="server" /></p>
            <span class="passing-score-badge"><asp:Label ID="PassingScore" runat="server" /></span>
        </div>

        <!-- QUESTION STATUS -->
        <div class="question-status-bar">
            <span class="question-counter"><asp:Label ID="QuestionCounter" runat="server" /></span>
        ...
        <div class="question-card">
            <h3>Instruction</h3>
            <p class="instruction-text"><asp:Label ID="QuestionInstruction" runat="server" /></p>
        </div>

        <!-- RECORDING -->
        <div class="recording-card">
            <h3>Record Your Answer</h3>
            <button type="button" id="StartRecordingBtn" onclick="startRecording()" class="recording-btn start">Start Recording</button>
            <button type="button" id="StopRecordingBtn" onclick="stopRecording()" disabled class="recording-btn stop">Stop Recording</button>
            <span class="recording-status"><asp:Label ID="RecordingStatus" runat="server" Text="Press Start Recording when ready." /></span>
        </div>

        <!-- RESULTS -->
        <div class="result-grid">
            <div class="result-item">
                <span class="result-label">Detected Notes</span>
                <span class="result-value"><asp:Label ID="DetectedNotesDisplay" runat="server" Text="—" /></span>
            </div>
            <div class="result-item">
                <span class="result-label">Expected Notes</span>
                <span class="result-value"><asp:Label ID="ExpectedNotesDisplay" runat="server" Text="—" /></span>
            </div>
            <div class="result-item">
                <span class="result-label">Accuracy</span>
                <span class="result-value accuracy"><asp:Label ID="AccuracyDisplay" runat="server" Text="—" /></span>
            </div>
        </div>
        ...
        <div class="exam-nav">
            ...
            <asp:Button ID="SubmitBtn" runat="server" Text="Submit Exam" OnClick="Submit_Click" CssClass="btn-success" Visible="false" />
        </div>
